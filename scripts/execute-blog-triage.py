...
def parse_faqs(html: str, lang: str) -> list[tuple[str, str]]:
    """Visible FAQ blocks only — shared with fix_noindex_common."""
    from fix_noindex_common import extract_visible_faq_pairs

    return extract_visible_faq_pairs(html, min_pairs=1, max_pairs=8)
