...
تم ربط Google Drive عبر rclone. أقدر أسحب الملفات وأرفعها.

**المجلد الرئيسي:** `📁 Dot4Life — فريق`

| القسم | صاحب الملفات |
|-------|-------------|
| `01-🎨-عمر-تصميم` | 🎨 عمر — تصاميم، صور، ثمبنيلز |
| `02-✍️-موني-مقالات` | ✍️ موني — نصوص، مسودات، مقالات |
| `03-🔍-ميدو-SEO` | 🔍 ميدو — تقارير، تحليلات |
| `04-🎬-هيما-فيديو` | 🎬 هيما — فيديوهات خام ومنشورة |
| `05-🤖-لينو-تقنية` | 🤖 لينو — سكربتات، ملاحظات |
| `06-📈-مازن-سوشيال-ميديا` | 📈 مازن — منشورات، جدول |
| `07-📊-اعلانات` | 📊 Ads Manager — تقارير، استراتيجيات |
| `08-👻-جوست-قرارات` | 👻 أنت — موافقات، توجيهات |

سير العمل: **← يرفع العضو → 📁 Drive ← 🤖 ينقل → 💻 مستودع → 🌐 الموقع**
