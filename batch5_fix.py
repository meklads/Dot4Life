...
def process_article(config):
    ...
    # Read from git
    ar_html = os.popen(f'git show HEAD:blog/{name}-ar.html 2>/dev/null').read()
    ...
    if toc_items:
        ...
        en_toc_links = f'<div class="sidebar-module sidebar-toc"><h4>📑 Contents</h4>{en_toc_links}</div>'
...
<head><script>(function(){{var h=document.documentElement,t=localStorage.getItem("dfl-theme")||"light";h.setAttribute("data-lang","en");h.setAttribute("lang","en");h.setAttribute("dir","ltr");h.setAttribute("data-theme",t);}})()</script>
  ...
  <meta property="og:title" content="{en_title}" /><meta property="og:url" content="https://dotforlife.com/blog/{name}-en.html" />
  <link rel="alternate" hreflang="en" href="https://dotforlife.com/blog/{name}-en.html" />
  <link rel="alternate" hreflang="ar" href="https://dotforlife.com/blog/{name}.html" />
  <link rel="stylesheet" href="/styles/global.css?v=20260617c"><link rel="stylesheet" href="/styles/pages/articles.css?v=20260617a">
...
<body data-template="article">
<nav id="navbar"><div class="nav-inner"><a href="/" class="nav-logo"><img src="/assets/images/logo1-footer.webp" alt="DOTFORLIFE" width="100" height="100"></a><ul class="nav-links"><li><a href="/health.html">Health</a></li><li><a href="/finance.html">Finance</a></li><li><a href="/real-estate.html">Real Estate</a></li><li><a href="/travel.html">Travel</a></li><li><a href="/islamic.html">Islamic</a></li><li><a href="/about.html">About</a></li><li><a href="/archive.html">Archive</a></li><li><a href="/blog.html">Blog</a></li></ul><div class="nav-controls"><button class="nav-btn" id="lang-toggle">العربية</button></div></div></nav>
<div class="article-wrap"><div class="article-layout" style="display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:2.5rem">
<main class="article-main"><article class="article-body">
{en_body}
</article></main>
<aside class="article-sidebar">
<div class="sidebar-module sidebar-team-card"><img src="/assets/images/logo1-footer.webp" alt="DOTFORLIFE" width="56" height="56"><div class="team-name">DOTFORLIFE Team</div><div class="team-trust">Trusted content for Gulf families.</div></div>
{en_toc_links}
</aside>
</div></div>
<footer class="site-footer"><div class="footer-inner"><div class="footer-bottom"><span>© 2026 DOTFORLIFE</span></div></div></footer>
<script src="/scripts/global.js?v=20260617a" defer></script>
</body>
</html>''')
