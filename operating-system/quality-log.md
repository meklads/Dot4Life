...
|---------|----------------|------------------|
| 2026-09-02 21:30 UTC | **الميراث: بطاقات الأربع انهارت وصارت الحروف عمودية، وسايدبار الأدوات غطّى الجسم، والصورة الأولى أيقونة SVG مسطّحة.** | بطاقات المعلومات صفين لا أربعة. السايدبار ينزل تحت الاستوديو دون 1200px. ملصق عمودي `inherit-poster.svg` + قص دفتر الأسرة. العمود يمدّ مع ارتفاع النموذج. لا فقه جديد. |
| 2026-09-02 20:55 UTC | **ست غرف العدّة بقيت فورم بعرض الجسم بعد نجاح استوديو الفندق.** أزرار الحساب لا تزال `width:100%`. | نفس نمط الثلث/الثلثين: صورتان مقصوصتان لاصقتان بجانب النموذج في الزكاة، البيت، الراتب، الشهر، الماء، الميراث. أزرار الحساب `inline-flex` بعرض النص. لا معادلات. لا نافبار. لا overlay. |
| 2026-09-02 20:20 UTC | **بطاقة الفندق: النموذج بعرض الصفحة والزر شريط كامل.** الطبقة البصرية السابقة لم تكسر `width:100%`. | استوديو ثلث/ثلثين: صورتان مقصوصتان (مكة/المدينة) لاصقتان بجانب النموذج. زر الحفظ `inline-flex` بعرض النص. لم تُمسَّ بقية الأدوات حتى يعتمد جوست الشكل. |
| 2026-09-02 19:50 UTC | **غرف العدّة كانت صحيحة وظيفياً وبلا هوية بصرية: هيرو بلا صورة، أزرار أكبر من الحاجة، وألوان أدوات متنافرة أو متطابقة (فندق=ماء).** المكتبة كانت تعرض صورة BMI في دائرة البيت. | طبقة `family-kit-visual.css`: تدرج موضوع لكل غرفة فوق تيل البيت، رسم SVG صغير في طرف الهيرو، أيقونات على بطاقات العدّة، مقياس أزرار موحّد، فونت Inter/Almarai. بطاقات الـoverlay بقيت `#054241`. بطاقة الفندق للسائق بقيت تيل. لا معادلات جديدة. لا نافبار. |
