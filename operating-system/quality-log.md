...
|---------|----------------|------------------|
| 2026-09-03 04:20 UTC | **مكتبة الأدوات: عدة الأسرة غرفة، وباقي الفئات صفوف مسطّحة بنفس الأيقونة بلا لون.** | كل فئة صارت غرفة بهوية: صحة أخضر هادئ، مالية ذهب، إسلاميات نيلي، سفر رمل. رأس ملوّن + رسم + بطاقات بأيقونات مختلفة ونص قصير. التبويبات حبوب بلون الفئة. عدة الأسرة بقيت البيت التيل. لا نافبار. لا فقه جديد. |
