...
| من | ماذا | ملاحظة |
|-----|------|--------|
| عمر + عامر | Batch 02 — **7 أقسام** · صور (B2-01,03,09,10 فوراً) | `batch-02-prompts.md` |
...
|---|--------|--------|-------|-----|
| T-01 | **Batch 02 — 10 مقالات · 7 أقسام** | Hema×3 · عامر×4 · Cursor×3 | `batch-02-launch.md` | **24 يونيو** |
