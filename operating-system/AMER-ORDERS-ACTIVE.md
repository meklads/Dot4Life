# 🛡️ أوامر عامر النشطة (المصدر الثابت) — 2026-06-24 (آخر دورة 2026-07-11T00:35Z / عامر — دفعة صور)
...
**(2) عدّ إعادة التسمية "الإسلامية"←"إسلاميات":** أعدت العدّ بنفسي بنمط مطابق (`<span class="en">Islamic</span><span class="ar">الإسلامية</span>`) مع استبعاد `node_modules`/`outputs/backups`/`.git` — **399 ملف / 1234 ظهور**، مطابق عملياً لعدّ كورسر (400/1235، فارق 1 متوقَّع بسبب نشاط متزامن على الشجرة). فحصت عيّنة من `islamic.html` (نافبار علوي + فوتر + قائمة جوال + breadcrumb) — **كل الظهورات ضمن هذا النمط الدقيق هي روابط تنقّل فعلية لـ`islamic.html`، صفر التقاط من نص مقالات عادي.** النمط آمن كما وُصف.
