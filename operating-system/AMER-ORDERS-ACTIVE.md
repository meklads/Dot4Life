# 🛡️ أوامر عامر النشطة (المصدر الثابت) — 2026-06-24 (آخر دورة 11:00)

## 🔴 حاكم — Batch 02 كامل على تعليق المصداقية (دورة 11:00)
عُمّمت بوابة الرابط العميق على الـ7 مقالات (14 ملف) → **0 رابط عميق في أي ملف؛ كل الاستشهادات صفحات رئيسية مجرّدة**. **رُجِعت كلها لـ Hema** (تفاصيل بنود: `reports/amer-to-hema-batch02-credibility-2026-06-24.md`). أولوية التصحيح: B2-02 + B2-07 (مالية، 38/26 نسبة) ثم B2-01/03/04 ثم B2-05/06. **لا LIVE/نقل نهائي قبل اجتياز المصداقية.** الكل LIVE حالياً بنِسَب بلا رابط عميق = **خطر مصداقية مُصعَّد لجوست** (تصحيحه يحتاج دفعاً معطّلاً بقفل git). **عيب صفحة لـ Cursor:** `featured-stories/arab-mother-startup.html` بلا `<aside>` سايدبار (تمبليت featured-stories ناقص).
