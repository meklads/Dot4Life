...
## إغلاق نهائي — 2026-06-26 21:50

**Q-01 مغلقة بالكامل: 15/15 PASS + LIVE-ready.**

بعد إصلاح هيما للصفحتين RETURN، فحص Cursor `scripts/q01_qa.py` أعاد:

- 15/15 FAQPage = FAQ المرئي.
- 15/15 JSON-LD صالح.
- 0 em-dash.
- 0 Unsplash.
- 0 FAQ يتيمة.
- 0 استشهاد مؤسسة/جامعة بلا رابط أو صياغة وصفية.
- 0 حشو FAQ من نوع «شامل/متوازن/مفصل».

إصلاحات الإغلاق:

- `beat-summer-boredom-without-screens`: أُزيل تكرار H2 وFAQ اليتيمة، ثم حُذفت ادعاءات جامعية بلا روابط من الجسم.
- `domestic-vs-international-travel-family`: أُزيل تكرار H2 وFAQ اليتيمة، وبقيت FAQ/السكيما 5/5.
- `hydration-guide`: تنظيف ادعاءات Mayo/WHO/Journal بلا روابط من الجسم.
- `umrah-with-kids-guide`: تحويل عنوان/ميتا «دليل شامل» إلى «دليل عملي».

**التالي:** D-01 جاهزة في `quality-d01-prep.md`، لكنها لا تصبح ACTIVE إلا برسالة إطلاق منفصلة.
