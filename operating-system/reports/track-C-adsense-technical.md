...
| C-F3 | Schema Article+FAQPage على كل المقالات | ⏳ PENDING | يلزم سكربت حقن + عيّنة تحقّق. |
| C-F5 | Title ≤60 / Meta ≤155 / hreflang | ⏳ PENDING | يُخرج CSV من `scripts/quality-audit.py`. |
| C-F6 | صورة WebP + alt لكل مقال | ⏳ PENDING | قائمة الناقص = 0 مطلوبة. |
| C-F7 | تنظيف الجذر (نسخ احتياطية، privacy مكرّر، sec1-6) | ⏳ PENDING | قائمة الملفات المحذوفة. |
...
**الحالة الآن: غير جاهز لإعادة AdSense** — C-F1/C-F2/C-F4 ✅؛ F3/F5/F6/F7 ⏳؛ TECH_BUILD بدأ (4 صفحات A-01).
